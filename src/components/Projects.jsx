...
export const Projects =()=> {
    ...
    const projectsUrl = ['frontend-nanodegree-arcade-game','fend-project-memory-game','React-random-color-picker','Ckbhatia.github.io','',''];
    return (
            ...
            <div className="part2">
            <a role="button" className="btn" href={`https://github.com/Ckbhatia/${projectsUrl[index]}`} target="_blank" rel="noopener noreferrer">Github</a>
